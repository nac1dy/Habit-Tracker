      ...
      <main className="min-h-screen bg-background py-8 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-(--teal-900) mt-1">Progress insights</h1>
            <p className="text-(--text-2)">Dummy stats to preview the analytics view.</p>
          </div>

          {/* Momentum scorecard (preview style) */}
          <div
          ...
          >
            <div className="flex items-end justify-between">
              <div>
                <p className="text-xs uppercase font-semibold text-(--text-3)">Momentum score</p>
                <p className="text-sm text-(--text-2)">Falls daily · stays green when habits are completed</p>
              </div>
              <div className="text-3xl font-extrabold text-(--teal-900)">82</div>
            </div>
            ...
            {/* Zone labels */}
            <div className="mt-2 grid grid-cols-3 text-xs text-(--text-3)">
              <span>low</span>
          ...
          <div className="mt-6 space-y-2">
            <div className="grid grid-cols-[32px_1fr_28px] items-center gap-2 text-sm text-(--text-2)">
              <span>Mon</span>
