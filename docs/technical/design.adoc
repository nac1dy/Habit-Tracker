...
| Habit-Manager
| Datenmanagement, Authentifizierung, Funktionlitäts-handler
| Supabase
...
repo --> ctrl : false
ctrl --> ctrl : HabitexistsalreadyException
...
.7+| statistics
| userid | SUID als Primärschlüssel; wird vom System generiert
...
| category | kategorie unter die das Habit fällt
| intervall |  Intervall in welchem das Habit erledigt werden soll
| momentum | momentum die der User zu diesem Habit gesammelt hat
|===
