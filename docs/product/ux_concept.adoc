...
| *Bezug zum Produkt*
| Mit wenig aufwand schnell Fortschritte sehen, Motivation durch Gamification, mit anderem Habit ersetzen
|===
...
| *Ziele*
| Struktur in meinen Alltag bringen, damit ich meine Ziele erreiche und mich weiterentwickle. Mehr mit Freunden zusammenarbeiten
...
| *Bezug zum Produkt*
| Mit wenig aufwand schnell Fortschritte sehen, Motivation durch Struktur und Gemeinsame Erfolge
...
_Dies ist der Onboarding-Flow von {project-system-name}. Wenn ein (uneingeloggter) Nutzer die App öffnet, wird er durch diesen Prozess geleitet, um sich einzuloggen oder zu registrieren._
