...
| *Ziele*
| Ich möchte mit Alkohol aufhören, weil meine Leber das nicht mehr mitmacht und damit erreichen, dass ich wieder 10km joggen kann.

| *Frustrationen*
| Effekt, Soziales Umfeld und Geschmack

| *Verhalten & Kontext*
| ist eher kontaktscheu und verbringt viel Zeit am Handy

| *Bezug zum Produkt*
| Sozialer Bezug (jemand, der ihm beim Aufhören hilft/ihn ermutigt), tägliche Erinnerung -> "bewusstes Aufhören"
|===

=== Persona 2: Sandro Selbstoptimierer

[cols="1,3"]
|===
| *Rolle*
| Start-Up-Gründer, Gym-Ratte, Influencer

| *Alter*
| 26 Jahre

| *Zitat*
| _„Erfolg ist die Fähigkeit, sich den Gegebenheiten anzupassen und diese zu seinem Vorteil zu nutzen."_

| *Ziele*
| seinen Alltag und seine Fitness/Ernährung optimieren, "to be the most interesting person in the room"

| *Frustrationen*
| Ziele aus den Augen verlieren

| *Verhalten & Kontext*
| extrovertiert, selbstkritisch, hat sehr viel David Goggins geschaut

| *Bezug zum Produkt*
| möchte einen Habit-Tracker nutzen, um seine Ziele im Blick zu behalten
|===
...
_Der Zweck dieses Dokuments ist es, die wesentlichen Bedarfe und Funktionalitäten des Systems {project-system-name} überblicksartig zu beschreiben. Der Fokus liegt auf den Fähigkeiten, die von Stakeholdern und adressierten Nutzern benötigt werden, und der Begründung dieser Bedarfe. Die Details, wie das System {project-system-name} diese Bedarfe erfüllt, werden durch User Stories im Product Backlog sowie dem UX-Konzept beschrieben._= UX-Konzept: {project-name}
Vorname Nachname <email@domain.org>; Vorname2 Nachname2 <email2@domain.org>; Vorname3 Nachname3 <email3@domain.org>
{localdatetime}
include::../_includes/default-attributes.inc.adoc[]
// Platzhalter für weitere Dokumenten-Attribute
