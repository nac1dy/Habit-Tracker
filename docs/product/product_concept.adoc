...
Es ist aktuell so leicht wie noch nie sich von Dingen abzulenken, nicht das zu machen was man machen möchte/sollte/muss und genau da Komfort zu finden. Und sobald man es bemerkt ist es zu spät, um dem entgegen zu wirken oder um es zu verhindern, braucht es manchmal Unterstützung von Außen und genau da kommt ein Habit Tracker gerade richtig.
...
Habito ist der Helfer wenn es um Aufbau und Abbau von Habits geht. Er unterstützt dich ohne es Anstrengend zu machen und reicht dir da die Hand wo du sie brauchst.
...
| Studenten
| Personen im Alter von 18-30 welche gute Habits aufbauen und schlechte Abbauen wollen
