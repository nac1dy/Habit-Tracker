...
TODO: Wettbewerber wie "Loop Habit Tracker", "HabitNow", "HabitKit", "TheFor"... ergänzen, Disciplined als zu allgemeine Alternative streichen oder besser begründen.
